...
namespace BarbeariaABC.API.Controllers
{
    ...
    public class FuncionariosController : ControllerBase
    {
        ...
        public FuncionariosController(IFuncionarioRepository repo, ILogger<FuncionariosController> logger)
        {
            _repo = repo;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Add(Funcionario obj)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] Funcionario obj)
        {
            if (id != obj.Id)
            {
                return BadRequest();
